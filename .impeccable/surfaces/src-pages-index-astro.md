...
related_targets: ["src/pages/games.astro","src/pages/about.astro"]
---

Mode: Persuade. Scope: Home and the studio-to-Games-to-About journey.

Audience: visitors curious about the family studio and its games. They should first understand who makes the work, then discover Trash Dash as the first project of a studio that will make more.
...
Future: Games becomes a collection with per-game detail routes when a second game exists. The studio story can host real anecdotes later; no empty updates feed now. Optional asset needs are documented separately. Publishing remains gated by explicit owner confirmation after local testing.
